...
public class MenuCadastrarProduto {
    ...
    public void cadastrarComputador(){
        ...
        this.catalogo.adicionar(new Computador(id, marca, modelo, lote, preco, memoriaRam, armazenamento, sistemaOperacional));
    }
    ...
    public void cadastrarMonitor(){
        ...
        this.catalogo.adicionar(new Monitor(id, marca, modelo, lote, preco, tamanho, taxaDeAtualizacao, resolucao, tipoDeTela));
    }
